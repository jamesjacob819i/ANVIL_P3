...
def format_slack_message(event: SentinelEvent) -> dict:
    ...
    if event.topic == "incidents.new":
    ...
    elif event.topic == "diagnostics.done":
        ...
        fields.append({"type": "mrkdwn", "text": f"*Summary:* {summary_text[:100]}..."})
        ...
        fields.append({"type": "mrkdwn", "text": f"*Agent Evaluation:* {reasoning[:100]}..."})
